...
<link rel="stylesheet" type="text/css" href="./static/css/jquery/easyui.css">
<%--<link rel="stylesheet" type="text/css" href="./static/css/jquery/icon.css">--%>
<link rel="stylesheet" type="text/css" href="./static/css/jquery/demo.css">
		...
		<div class="cloud">
			<div class="banner">
				...
				<div class="bannerCenter">
					<ul>
						<li class="active"><a href="index.do"><spring:message code="wp"/></a></li>
						<li><a href="index.do"><spring:message code="fx"/></a></li>
						<li><a href="fileupload.jsp"><spring:message code="zzsc"/></a></li>
						<li><a href="filedownload.jsp"><spring:message code="zzxz"/></a></li>
					</ul>
				</div>
				<div class="bannerRight">
					<span><a href="translate.do?local=zh">中文</a></span>
					<span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
					<span><a href="translate.do?local=en">English</a></span>
					<span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
					<span class="person"><img src="./static/images/person.jpg"></span> <span>${user.userName}</span>
