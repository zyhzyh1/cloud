...
<body>
	<div id="register">
		<div class="registerTop">
			<div class="topContent">
				...
				<div class="contentRight">
					<span>已有账号</span> <span class="login"> <a href="hello.do">
			...
			<div class="reContent">
				<div class="reContentLeft">
					<form action="register.do" method="post"
						...
						<div>
							几级：<input type="text" id="role" name="roleId"
										placeholder="几级标明">
						</div>
						<div>
							是否为vip：<input type="text" id="vip" name="isVip"
										placeholder="是否为vip">
						</div>
						<div>
							状态：<input type="text" id="statu" name="status"
									  placeholder="用于标明状态">
						</div>
						<div class="check">
		...
		<div class="reBottom">
			<img src="./static/images/foot_pic.jpg">
		</div>
	</div>
</body>
</html>